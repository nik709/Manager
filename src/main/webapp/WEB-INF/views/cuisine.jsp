...
<a style="margin-left: 100px" href="/addingCuisine"><img src="/resources/pictures/db_add.png"/></a>
    ...
    <c:if test="${!empty cuisineList}">
        <table class="searchTable">
            ...
            <c:forEach items="${cuisineList}" var="cuisine">
                <tr>
                    <td class="searchTd">${cuisine.name}</td>
                    <td class="searchTd"><input class="bigbox" type="radio" name="id" value="${cuisine.id}"></td>
                </tr>
            </c:forEach>
        </table>
