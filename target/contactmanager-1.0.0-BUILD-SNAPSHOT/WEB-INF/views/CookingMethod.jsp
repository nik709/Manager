...
<html>
<head>
    <title><spring:message code="entity.CookMethod"/></title>
</head>
<body>

<a href="/MenuPage"><img src="/resources/pictures/back.png"></a>
<a style="margin-left: 100px" href="/addingCookMethod"><img src="/resources/pictures/db_add.png"/></a>

<h1>
    <spring:message code="entity.CookMethod"/>
</h1>
    ...
    <c:if test="${!empty methodList}">
        <table class="searchTable">
            ...
            <c:forEach items="${methodList}" var="method">
                <tr>
                    <td class="searchTd">${method.name}</td>
                    <td class="searchTd"><input class="bigbox" type="radio" name="id" value="${method.id}"></td>
                </tr>
            </c:forEach>
        </table>
...
<%
    ...
    if (select != null && select.length != 0) {
        ...
        response.sendRedirect("/CookingMethod");
    }
%>
